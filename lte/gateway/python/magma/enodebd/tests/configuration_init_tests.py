...
class EnodebConfigurationFactoryOfRTSTest(TestCase):
    ...
    def test_set_ho_algorithm_config(self):
        ...
        _set_ho_algorithm_config(self.cfg, ho_algorithm_config)

        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_A1_THRESHOLD_RSRP), ho_algorithm_config.a1_threshold_rsrp,
            'HO_A1_THRESHOLD_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_A2_THRESHOLD_RSRP), ho_algorithm_config.a2_threshold_rsrp,
            'HO_A2_THRESHOLD_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_A3_OFFSET), ho_algorithm_config.a3_offset,
            'HO_A3_OFFSET value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_A3_OFFSET_ANR), ho_algorithm_config.a3_offset_anr,
            'HO_A3_OFFSET_ANR value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_A4_THRESHOLD_RSRP), ho_algorithm_config.a4_threshold_rsrp,
            'HO_A4_THRESHOLD_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_LTE_INTRA_A5_THRESHOLD_1_RSRP), ho_algorithm_config.lte_intra_a5_threshold_1_rsrp,
            'HO_LTE_INTRA_A5_THRESHOLD_1_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_LTE_INTRA_A5_THRESHOLD_2_RSRP), ho_algorithm_config.lte_intra_a5_threshold_2_rsrp,
            'HO_LTE_INTRA_A5_THRESHOLD_2_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_LTE_INTER_ANR_A5_THRESHOLD_1_RSRP), ho_algorithm_config.lte_inter_anr_a5_threshold_1_rsrp,
            'HO_LTE_INTER_ANR_A5_THRESHOLD_1_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_LTE_INTER_ANR_A5_THRESHOLD_2_RSRP), ho_algorithm_config.lte_inter_anr_a5_threshold_2_rsrp,
            'HO_LTE_INTER_ANR_A5_THRESHOLD_2_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_B2_THRESHOLD1_RSRP), ho_algorithm_config.b2_threshold1_rsrp,
            'HO_B2_THRESHOLD1_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_B2_THRESHOLD2_RSRP), ho_algorithm_config.b2_threshold2_rsrp,
            'HO_B2_THRESHOLD2_RSRP value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_B2_GERAN_IRAT_THRESHOLD), ho_algorithm_config.b2_geran_irat_threshold,
            'HO_B2_GERAN_IRAT_THRESHOLD value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_QRXLEVMIN_CHOICE), ho_algorithm_config.qrxlevmin_sib1,
            'HO_QRXLEVMIN_CHOICE value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_QRXLEVMINOFFSET), ho_algorithm_config.qrxlevminoffset,
            'HO_QRXLEVMINOFFSET value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_S_INTRASEARCH), ho_algorithm_config.s_intrasearch,
            'HO_S_INTRASEARCH value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_S_NONINTRASEARCH), ho_algorithm_config.s_nonintrasearch,
            'HO_S_NONINTRASEARCH value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_QRXLEVMIN_RESELECTION), ho_algorithm_config.qrxlevmin_sib3,
            'HO_QRXLEVMIN_RESELECTION value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_THRESHSERVINGLOW), ho_algorithm_config.threshservinglow,
            'HO_THRESHSERVINGLOW value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_RESELECTION_PRIORITY), ho_algorithm_config.reselection_priority,
            'HO_RESELECTION_PRIORITY value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_CIPHERING_ALGORITHM), ho_algorithm_config.ciphering_algorithm,
            'HO_CIPHERING_ALGORITHM value should be same as what was set',
        )
        self.assertEqual(
            self.cfg.get_parameter(BaicellsParameterName.HO_INTEGRITY_ALGORITHM), ho_algorithm_config.integrity_algorithm,
            'HO_INTEGRITY_ALGORITHM value should be same as what was set',
        )
